...
class FreeWorldJobCardFPDF(FPDF):
                ...
                if os.path.exists(palatino_path):
                    try:
                        ...
                        if os.path.exists(bold_path):
                            ...
                            print(f"✅ Loaded Palatino (regular only) from system")
    ...
    def create_job_card(self, job, job_number=None, total_jobs=None):
        ...
        # Debug: Print available columns and match quality for troubleshooting
        print(f"🔍 Job columns available: {list(job.keys())}")
        print(f"🔍 Match quality found: '{match_quality}' from canonical mapping")
