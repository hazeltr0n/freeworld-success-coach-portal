...
def get_unified_sort_priority(row):
    ...
    fair_chance_val = row.get('ai.fair_chance', '')
    # Handle case where the stored value is None (shouldn't happen but being defensive)
    fair_chance = str(fair_chance_val or '').lower()
