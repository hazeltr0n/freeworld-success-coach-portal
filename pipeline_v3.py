...
class FreeWorldPipelineV3:
    ...
    def _stage1_ingestion(
        ...
        # Smart Memory Classification: Check if we already classified these fresh jobs
        ...
        if all_fresh_jobs:
            ...
            if memory_lookup:
                ...
                print(f"🧠 Smart Memory: Found existing classifications for {len(memory_jobs)} fresh jobs")
                ...
                try:
                    ...
                    print(f"   💰 Saved classifications: quality={total_quality} (good={good}, so-so={so_so}), bad={bad}")
                except Exception:
                    pass
