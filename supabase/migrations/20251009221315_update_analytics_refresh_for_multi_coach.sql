-- Update refresh_free_agents_analytics() to support multi-coach system
-- This fixes the refresh button not showing recent click activity
...
BEGIN
    ...
    LOOP
        ...
        -- Insert analytics record with multi-coach support
        INSERT INTO free_agents_analytics (
            ...
            rec.agent_name,
            rec.coach_username,
            COALESCE(rec.coach_usernames, ARRAY[rec.coach_username]::TEXT[]), -- Multi-coach support
            rec.agent_email,
            rec.agent_city,
            rec.agent_state,
            market_name,
    ...
    result_json := JSON_BUILD_OBJECT(
        ...
        'message', 'Free agents analytics refreshed successfully with multi-coach support'
    );
