-- Increase timeout for batch_insert_jobs_with_dedup RPC function
-- The default statement timeout is too short for processing large batches  
-- Set timeout to 5 minutes (300 seconds) for this function
...
COMMENT ON FUNCTION batch_insert_jobs_with_dedup IS 'Batch insert jobs with R3 deduplication (5 minute timeout)';
