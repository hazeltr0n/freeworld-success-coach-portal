-- Dual-Layer Deduplication Strategy
-- Layer 1: Handle job_id conflicts (re-scrapes) with full UPDATE
-- Layer 2: Clean up R3 duplicates AFTER insert, keeping most recent
...
BEGIN
    ...
    ON CONFLICT (job_id) DO UPDATE SET
        ...
        rules_duplicate_r3 = EXCLUDED.rules_duplicate_r3,  -- Update R3 hash if changed
...
COMMENT ON FUNCTION batch_insert_jobs_with_dedup IS 'Dual-layer dedup: job_id conflict handling + R3 cleanup';
